...
public class BubbleSortGUI_2511532001 extends JFrame {
     ...
     * Create the frame.
     */
    public BubbleSortGUI_2511532001() {
    ...
    private void setArrayFromInput_2001() {
        ...
        for (int k_2001 = 0; k_2001 < array_2001.length; k_2001++) {
            ...
            labelArray_2001[k_2001].setOpaque(true);
            labelArray_2001[k_2001].setBackground(Color.WHITE);
    ...
    private void performStep_2001() {
        if (!sorting_2001 || i_2001 >= array_2001.length - 1) {
            sorting_2001 = false;
            stepButton_2001.setEnabled(false);
        ...
        labelArray_2001[j_2001 + 1].setBackground(Color.CYAN);

        if (array_2001[j_2001] > array_2001[j_2001 + 1]) {
            // Swap
            int temp_2001 = array_2001[j_2001];
            array_2001[j_2001] = array_2001[j_2001 + 1];
            array_2001[j_2001 + 1] = temp_2001;

            labelArray_2001[j_2001].setBackground(Color.RED);
            labelArray_2001[j_2001 + 1].setBackground(Color.RED);

            stepLog_2001.append("Langkah ").append(stepCount_2001).append(": Menukar elemen ke-")
                    .append(j_2001).append(" (").append(array_2001[j_2001 + 1]).append(")")
                    .append(" dengan ke-")
                    .append(j_2001 + 1).append(" (").append(array_2001[j_2001]).append(")\n");
        } else {
            stepLog_2001.append("Langkah ").append(stepCount_2001)
                    .append(": Tidak ada pertukaran antara ke-")
                    .append(j_2001).append(" dan ke-").append(j_2001 + 1).append("\n");
        }
        ...
        j_2001++;
        if (j_2001 >= array_2001.length - i_2001 - 1) {
            j_2001 = 0;
            i_2001++;
        }
